...
/**
 * linear_skip - Searching for a value in a sorted singly linked list
 *               of integers using the linear skip.
 * @list: Is a pointer to the head of the linked list to search.
